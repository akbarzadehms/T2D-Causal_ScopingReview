...
if (nrow(df_non) > 0) {
  build_plot(
    df_non,
    title_text    = "Exposure: Infectious Disorders | Outcome: Type 2 Diabetes",
    subtitle_text = "Causal Effects of Infectious Diseases on Type 2 Diabetes",
    show_legend   = TRUE
  )
} else {
...
if (nrow(df_t2d) > 0) {
  build_plot(
    df_t2d,
    title_text    = "Exposure: Type 2 Diabetes | Outcomes: Infectious Disorders",
    subtitle_text = "Causal Effects of Type 2 Diabetes on Infectious Diseases",
    show_legend   = TRUE
  )
} else {
