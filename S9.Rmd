...
if (nrow(df_non) > 0) {
  build_plot(
    df_non,
    title_text    = "Exposure: Endocrine disorders | Outcome: Type 2 Diabetes",
    subtitle_text = "Causal Effects of Endocrine disorderss on Type 2 Diabetes",
    show_legend   = TRUE
  )
} else {
...
if (nrow(df_t2d) > 0) {
  build_plot(
    df_t2d,
    title_text    = "Exposure: Type 2 Diabetes | Outcomes: Endocrine disorders",
    subtitle_text = "Causal Effects of Type 2 Diabetes on Endocrine disorderss",
    show_legend   = TRUE
  )
} else {
