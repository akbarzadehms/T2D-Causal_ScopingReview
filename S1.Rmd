...
if (nrow(df_non) > 0) {
  build_plot(
    df_non,
    title_text    = "Exposure: Health determinants | Outcome: Type 2 Diabetes",
    subtitle_text = "Causal Effects of Health determinants on Type 2 Diabetes",
    show_legend   = TRUE
  )
} else {
...
if (nrow(df_t2d) > 0) {
  build_plot(
    df_t2d,
    title_text    = "Exposure: Type 2 Diabetes | Outcomes: Health determinants",
    subtitle_text = "Causal Effects of Type 2 Diabetes on Health determinants",
    show_legend   = TRUE
  )
} else {
