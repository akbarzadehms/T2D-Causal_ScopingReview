...
if (nrow(df_non) > 0) {
  build_plot(
    df_non,
    title_text    = "Exposure: Musculoskeletal disorders | Outcome: Type 2 Diabetes",
    subtitle_text = "Causal Effects of Musculoskeletal disorders on Type 2 Diabetes",
    show_legend   = TRUE
  )
} else {
...
if (nrow(df_t2d) > 0) {
  build_plot(
    df_t2d,
    title_text    = "Exposure: Type 2 Diabetes | Outcomes: Musculoskeletal disorders",
    subtitle_text = "Causal Effects of Type 2 Diabetes on Musculoskeletal disorders",
    show_legend   = TRUE
  )
} else {
